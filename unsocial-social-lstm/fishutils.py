...
class DataLoader():
    ...
    def __init__(self, batch_size=50, seq_length=5, datasets=[0], forcePreProcess=False):
        ...
        self.data_dirs = ['../data/fish/170202_pi11_SOLI_S17_F175_TR']

        #self.data_dirs = ['../data/fish/CM1FRE_150324_1147_RP10_S04_G22_P']
        ...
        data_file = os.path.join(self.data_dir, "fish-trajectories.cpkl")
